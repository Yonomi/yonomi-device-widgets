...
// in yonomi_device_widgets/test/providers/color_temperature_provider_test.dart.
...
import 'color_temperature_provider_test.dart' as _i3;
...
/// A class which mocks [SetColorTemperatureMethod].
///
/// See the documentation for Mockito's code generation for more information.
class MockSetColorTemperatureMethod extends _i1.Mock
    implements _i3.SetColorTemperatureMethod {
  MockSetColorTemperatureMethod() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<void> call(
          _i2.Request? request, String? id, int? colorTemperature) =>
      (super.noSuchMethod(
          Invocation.method(#call, [request, id, colorTemperature]),
