...
[LockSlimWidget](../traits_slim_lock_slim_widget/LockSlimWidget/LockSlimWidget.md) ([LockProvider](../providers_lock_provider/LockProvider-class.md) lockProvider, {[Color](https://api.flutter.dev/flutter/dart-ui/Color-class.html)? backgroundColor, [Key](https://api.flutter.dev/flutter/foundation/Key-class.html)? key})
