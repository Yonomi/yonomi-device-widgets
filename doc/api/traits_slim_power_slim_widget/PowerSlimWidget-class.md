...
[PowerSlimWidget](../traits_slim_power_slim_widget/PowerSlimWidget/PowerSlimWidget.md) ([PowerTraitProvider](../providers_power_trait_provider/PowerTraitProvider-class.md) powerProvider, {[Color](https://api.flutter.dev/flutter/dart-ui/Color-class.html)? backgroundColor, [Key](https://api.flutter.dev/flutter/foundation/Key-class.html)? key})
