...
[BatteryLevelIcon](../assets_traits_battery_level_icon/BatteryLevelIcon/BatteryLevelIcon.md) ([int](https://api.flutter.dev/flutter/dart-core/int-class.html) batteryLevel, {dynamic size = WidgetStyleConstants.defaultDeviceIconSize, dynamic color = WidgetStyleConstants.deviceIconColor, [Key](https://api.flutter.dev/flutter/foundation/Key-class.html)? key})
