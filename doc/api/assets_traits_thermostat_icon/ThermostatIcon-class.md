...
[ThermostatIcon](../assets_traits_thermostat_icon/ThermostatIcon/ThermostatIcon.md) ({[double](https://api.flutter.dev/flutter/dart-core/double-class.html)? thermostatState, [Decoration](https://api.flutter.dev/flutter/painting/Decoration-class.html)? decoration, [TextStyle](https://api.flutter.dev/flutter/painting/TextStyle-class.html)? textStyle, [Key](https://api.flutter.dev/flutter/foundation/Key-class.html)? key})
...
##### [build](../assets_traits_thermostat_icon/ThermostatIcon/build.md)([BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html) context) [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)



Describes the part of the user interface represented by this widget. [...](../assets_traits_thermostat_icon/ThermostatIcon/build.md)  
_override_
