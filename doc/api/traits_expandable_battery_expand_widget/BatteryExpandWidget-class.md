...
[BatteryExpandWidget](../traits_expandable_battery_expand_widget/BatteryExpandWidget/BatteryExpandWidget.md) (dynamic _batteryLevelTraitProvider, {[Color](https://api.flutter.dev/flutter/dart-ui/Color-class.html)? backgroundColor, [Key](https://api.flutter.dev/flutter/foundation/Key-class.html)? key})
